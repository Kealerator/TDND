...
public class validator {
    ...
    public void diceRollInputDecipher(String input) {
        ...
        if (input.contains("+")) {
            ...
            String[] pieces = input.split("d");     // the "[]" are removed because we aren't splitting the
                if (pieces[0].isEmpty()){
                    pieces[0] = "1";
                }
            this.diceAmount = Integer.parseInt(pieces[0]);         // plus or minus.
            this.diceType = Integer.parseInt(pieces[1]);
            this.bonusType = "none";
        }
